...
export const useCategoriesStore = defineStore('categories', {
  ...
  actions: {
    ...
    async newItem(payload) {
      this.startLoading();
      try {
        const result = await axios.post('/categories', { data: payload });
        this.showNotification('Categories has been created', 'success');
    ...
    async edit(payload) {
      ...
      try {
        ...
        // 
        this.showNotification('Categories has been updated', 'success');
        this.getData(result.data)
      } catch (e) {
