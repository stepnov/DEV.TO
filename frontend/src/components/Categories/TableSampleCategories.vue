...
/* Delete item */
const deleteItem = () => {
  categoriesStore.deleteItem(currentId.value)
}

const items = computed(() => categoriesStore.data)
  ...
  <table>
    ...
    <tbody>
      <tr
        ...
        :key="client.id"
        @click="$router.push(`/categories/${client.id}/edit`)"
      >
        <TableCheckboxCell
          v-if="checkable"
